---
sidebar_position: 18
title: "Benchmarks & Case Studies"
description: "Skylos vs Vulture benchmark on 9 top Python repos (350k+ stars). 95% recall vs 70%, 3x fewer false positives. Manually verified results."
---
