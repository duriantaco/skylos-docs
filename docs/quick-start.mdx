---
title: "Quick Start"
description: "Get started with Skylos in under 2 minutes. Install, scan for dead code, vibe coding defects, prompt injection, and security vulnerabilities in Python, TypeScript, and Go."
---
