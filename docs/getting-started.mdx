...
dead code, dangerous flows, secrets, quality, dependency, and AI-defect checks:
...
- **AI Defects** (`--ai-defects`): Evidence-backed AI-code failure modes such as phantom references, hallucinated APIs, impossible dependency versions, and weakened assertions.
