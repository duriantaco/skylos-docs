---
title: Installation
description: "Install Skylos via pip. Static analysis and dead code detection for Python 3.10+, TypeScript, JavaScript, Java, Go, Kotlin, PHP, Rust, Dart, C#, and Shell."
---
