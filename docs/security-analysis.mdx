...
description: "Python SAST with taint analysis. Detect SQL injection, command injection, SSRF, XSS, path traversal, hardcoded secrets, and prompt injection payloads across data flows. AI supply chain security for codebases using LLM agents."
---
