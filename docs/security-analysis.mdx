...
:::info
  **Enable security scanning:** `skylos . --danger` for static taint and dangerous-pattern checks, or `skylos agent scan . --security` for the verifier-backed security taskflow.
:::
