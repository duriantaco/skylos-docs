...
Skylos is a static analysis tool for Python, TypeScript, JavaScript, Java, Go, Kotlin, PHP, Rust, Dart, C#, and Shell that detects:
...
skylos . --danger --quality --ai-defects --gate    # With quality gate
```
