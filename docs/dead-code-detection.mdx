...
description: "Detect unused functions, imports, classes, and variables in Python, TypeScript, JavaScript, Java, Go, Kotlin, PHP, Rust, and Dart. Framework-aware dead code detection for Django, FastAPI, Flask, Spring, React, Next.js, Flutter, and Pydantic."
---
