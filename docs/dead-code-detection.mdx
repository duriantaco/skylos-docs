...
description: "Detect unused functions, imports, classes, and variables in Python, TypeScript, JavaScript, Java, Go, PHP, and Rust. Framework-aware dead code detection for Django, FastAPI, Flask, Spring, React, Next.js, and Pydantic."
---
