...
description: "Scanner scope for Python, TypeScript, JavaScript, Java, Go, PHP, Rust, Dart, Shell, and security-relevant deployment config."
---
...
Python API, a TypeScript frontend, a Go service, a Dart mobile client, and
Shell deployment scripts can be scanned from the repository root.
