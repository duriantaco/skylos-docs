---
title: "AI Defense"
description: "Reference for Skylos AI Defense checks. For current pre-deployment agent verification outputs, evidence reports, SARIF, and attestation, see Agent Verification."
---
...
:::tip Current workflow
For current pre-deployment AI agent verification, including `--format md`, `--format sarif`, GitHub step summaries, framework evidence, MCP `verify_agent`, and reproducible attestation, see [Agent Verification](/agent-verification).
:::
