...
description: "Detect AI-generated code defects — phantom functions, hallucinated decorators, stale mocks, unfinished stubs, and undefined config flags. Vibe coding guardrails for Copilot, ChatGPT, and Claude."
---
...
modes common in AI-generated code. AI-defect checks (`SKY-A101` to `SKY-A104`,
...
keep their existing buckets. See [AI Defect Verification](../ai-defects) for
...
| `SKY-A103` | **CI permission expansion** — GitHub Actions write permissions or privileged triggers added in a diff | Agents can over-broaden CI privileges while trying to make workflows pass | `ci_permission_expansion` |
| `SKY-A104` | **Public CLI surface drift** — argparse, Click, or Typer flags removed in a diff | Refactors can silently break scripts, docs, and CI jobs that depend on stable flags | `public_api_surface_drift` |
