...
| **AI Security Scan** | `skylos agent scan --security .` | Deep LLM review with interactive file selection |
...
| Flag | Description |
|------|-------------|
| `--upload` | Upload scan results to Skylos Cloud (requires `skylos login` first). Costs 1 credit. |
