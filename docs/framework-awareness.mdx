...
description: "Reduce false positives with framework-aware analysis. Skylos recognizes Django views, Flask routes, FastAPI endpoints, Pydantic models, and pytest fixtures."
---
