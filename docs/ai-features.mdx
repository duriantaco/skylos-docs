...
hallucinations, and API signature hallucinations. Full scan JSON reports the
strict hallucination rules under `ai_defects` rather than `quality` or
`danger`.
...
AI-defect rules, verifier filtering, package hallucination detection, or
